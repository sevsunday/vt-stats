...
- **Powerup Economy** — separates real vehicle kills from crate/pod pickups, destructions (powerups shot before pickup), and deployable mine destructions; surfaces a Powerup/Crate Destruction Breakdown chart and a Snipe Feed on the Combat tab
